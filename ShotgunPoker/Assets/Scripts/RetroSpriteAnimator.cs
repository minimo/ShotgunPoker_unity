...
public class RetroSpriteAnimator : MonoBehaviour {
    ...
    private RetroSpriteAnimation tempAnimation = new RetroSpriteAnimation() ;
    ...
    public void setFrameIndex(int index, float FrameRate = 30, bool FlipX = false, bool FlipY = false)
    {
        // tempAnimation.name = "frameindex";
        // tempAnimation.frames = new int[] { index };
        // tempAnimation.frameRate = 1 / FrameRate;
        // tempAnimation.looped = false;
        // tempAnimation.flipX = FlipX;
        // tempAnimation.flipY= FlipY;
